/**
 * Channel bridge Unix socket server for bloom-channels.
 * Manages socket connections, heartbeat, rate limiting, and message routing.
 */
...
import { setPairingData } from "./pairing.js";
