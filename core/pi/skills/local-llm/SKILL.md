...
llama-server runs on every Garden OS instance and is always available at boot. It provides an OpenAI-compatible API for LLM inference.
...
To switch models, update `core/os/modules/llm.nix` in the Garden repo:
