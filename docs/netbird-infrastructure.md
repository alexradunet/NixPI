...
EU-hosted mesh networking for secure remote access to your Workspace device. Uses NetBird cloud management (free tier, up to 5 peers).
...
NetBird authentication is handled during Workspace's first-boot wizard using a setup key. If you need to re-authenticate:
