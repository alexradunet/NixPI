...

{
  ...
  testScript = ''
    ...
    nixpi.succeed("grep -q 'Remote access' /etc/system-services/nixpi-home/webroot/index.html")
    nixpi.succeed("grep -q 'http://localhost:8080/' " + home + "/.config/nixpi/services/home/index.html")
    nixpi.succeed("grep -q 'http://localhost:8081/' " + home + "/.config/nixpi/services/home/index.html")
    nixpi.succeed("grep -q 'http://localhost:6167' " + home + "/.config/nixpi/services/home/index.html")
